...
const challenges = [
  {
    ...
    description:
      "Your product roadmap is delayed, features take months to ship, and technical decisions slow business growth. I help identify bottlenecks, streamline processes, and create scalable development practices that align engineering velocity with business objectives.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Your original developers are overwhelmed, code quality is declining, and new hires struggle to contribute effectively. I establish scalable team structures, mentoring programs, and development practices that maintain quality while growing fast.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Simple changes take weeks, bugs multiply faster than fixes, and your system feels increasingly fragile. I create pragmatic technical debt reduction strategies that balance immediate business needs with long-term maintainability and system health.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "You need senior technical leadership to guide architecture decisions, technology choices, and team development, but can't justify a full-time executive hire. I provide strategic oversight and tactical guidance scaled to your current needs and growth stage.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Fundraising, acquisition discussions, or rapid scaling demand technical due diligence and architecture that can handle significant growth. I assess current systems, identify scaling risks, and implement the technical foundation needed for your next milestone.",
  },
  {
    icon: (
      <svg
...
export function Services() {
  ...
  return (
    <>
      <section
        id="services"
        className="py-12 bg-accent-1/50 dark:bg-accent-3/5 scroll-mt-20"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-accent-3 dark:text-accent-1 leading-relaxed">
              For the complex technical problems fast-paced growing companies
              face when scaling their engineering capabilities. Here's how I
              help solve them through strategic leadership and proven solutions.
            </p>
          </div>
          ...
          <div className="text-center bg-primary/5 dark:bg-accent-1/5 rounded-2xl p-8 lg:p-12">
            ...
            <p className="text-lg text-accent-3 dark:text-accent-1 mb-8 max-w-2xl mx-auto">
              Let's discuss how to accelerate your growth and help you build the
              high-performing engineering organization you need.
            </p>
