...
const faqs = [
  ...
  },
  {
    ...
    answer: "Fractional CTO services offer immediate expertise without the 6-12 month hiring process. You get proven technical leadership from day one, with the flexibility to scale engagement up or down based on your company's growth stage and needs. This approach is ideal for companies that need senior technical guidance but aren't ready for a full-time executive hire."
  },
  {
    question: "What size companies benefit most from fractional CTO services?",
    answer: "Growing companies with 10-100 employees typically see the greatest value from fractional CTO services. This includes startups scaling beyond their founding team, established companies launching digital initiatives, and businesses experiencing technical bottlenecks that impact growth."
  },
  {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center bg-primary/5 dark:bg-accent-1/5 rounded-2xl p-8 lg:p-12">
              ...
              <p className="text-xl text-accent-3 dark:text-accent-1 mb-8 max-w-3xl mx-auto">
                Let's discuss how I can help you build scalable systems, implement smart technology solutions,
