---
title: "The Knowledge That Disappears"
excerpt: "We are building systems to measure intelligence by decomposing it, while neuroscience shows intelligence is irreducibly systemic, and economics warns that making AI too capable may collapse the shared knowledge it depends on."
topic: "think"
date: "2026-03-20"
author:
  name: SVO
...
There's a move in Western thought, very old and deeply habitual, that Heidegger spent decades trying to make visible. He called it the theoretical attitude: the tendency to encounter something in the world and immediately try to understand it by breaking it apart, cataloging its properties, measuring its components. He described this as a shift from _Zuhandenheit_ to _Vorhandenheit_, from the ready-to-hand to the present-at-hand.
...
Around the same time DeepMind was proposing how to measure artificial intelligence, economists Daron Acemoglu, Dingwen Kong, and Asuman Ozdaglar at NBER were [publishing a model](https://www.nber.org/papers/w34910) of what happens to _human_ intelligence, specifically human knowledge, when AI gets too good.
...
[The Daily Nous blog](https://dailynous.com/2026/02/12/can-ai-write-a-useful-philosophical-literature-review-guest-post/) captured a miniature version of this dynamic recently. When philosophers were presented with PhilLit, an AI tool for literature review, the response wasn't the methodological debate that ChatGPT predicted. It was existential alarm. Philosophers saw the tool as threatening not their efficiency but their identity: the reading, writing, and intellectual struggle that constitutes what philosophy _is_. ChatGPT, [analyzing the gap](https://dailynous.com/2026/02/19/an-ai-analyzes-philosophers-discussion-of-ai/) between its predictions and reality, admitted it had "underestimated how symbolically charged AI has become." The tool functioned "less as a discrete proposal and more as a lightning rod for preexisting tensions."
...
The product insight is subtle but clear. The most valuable AI systems won't be the ones that give you the best answers. They'll be the ones that make human learning more productive and more shareable. Systems that route you _through_ the general knowledge rather than _around_ it. Systems that use their understanding of your context to connect you with the relevant shared understanding, rather than replacing your need to engage with it.
